...
public class FrontTypeController {
    ...
    //类型页面
    @RequestMapping(value = {"/frontend/types/{id}","/frontend/types"})
    public String types(@PathVariable(required = false) Long id,
        ...
        List<Type> types = typeService.findAllTypeListWithSort(); //查询所有的：types
        ...
        List<Blog> blogs = blogService.findBlogListByTypeId(id);        //通过typeId查询
